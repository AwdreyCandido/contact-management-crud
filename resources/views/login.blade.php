...
<body>
    ...
    <div class="h-screen w-full flex items-center justify-center">
        <form class="w-[22rem] p-4 rounded-xl gap-4 border border-gray-400 flex flex-col" action="/login"
            method="POST">
            @csrf
            ...
            <button class="bg-blue-400 hover:bg-blue-500 duration-300 mt-4 text-lg font-medium text-white px-6 py-2 rounded-lg">Log in</button>
        </form>
    </div>
</body>
